...
| **Problematics**                 | **Solutions**                                                      |
|----------------------------------|-------------------------------------------------------------------|
| Fairness                         | Workable AI ensures fairness by using objective, skills-based matching criteria without relying on Personal Identifiable Information (PII) in job suggestions. It consistently applies the same job matching criteria to all participants with similar qualifications and needs. Compatibility is evaluated based on relevant factors like skills, accommodations needed, transportation status, and employment goals—not personal characteristics. It maintains balance between participant needs and job requirements without favoring certain groups. |
| Reliability and Safety           | Workable AI ensures reliability and safety by analyzing multiple dimensions of compatibility (skills, accommodations, location, schedule, etc.) for robust matching. It presents job compatibility reasons that coaches can verify and validate. Final match decisions are left to human coaches who understand nuanced participant needs. Structured data schemas ensure consistent evaluation criteria. Coaches are supported with clear visualizations and organized information to prevent oversight of critical factors. Additionally, tools for ongoing session tracking and participant progress monitoring ensure continuous support. |
| Privacy and Security             | Workable AI protects privacy and security by not using Personal Identification Information in the job matching algorithms. It implements strict access controls where only authorized coaches can access their participants' personal information. Secure database partitioning with appropriate keys ensures data protection. Sensitive data is stored in compliance with data protection regulations. Personal identifiers are separated from matching criteria to maintain privacy during job suggestions. Additionally, participant data is securely stored in cloud infrastructure with clear data boundaries between different user roles. |
| Inclusiveness                    | Our solution is designed to support people with disabilities in finding and retaining meaningful employment. Workable AI promotes social inclusion by helping job coaches focus on empowering participants through AI-assisted insights. It considers accessibility features, supportive environments, and accommodation availability in job matches. |
| Transparency                     | Workable AI promotes transparency by clearly displaying compatibility reasons for each job match, helping coaches understand why specific recommendations were made. It shows match scores based on objective criteria from participant and job profiles. Detailed job information and participant requirements are presented side-by-side for transparent comparison. Coaches can see which specific factors (like required skills, accessibility features, and accommodations) contributed to match recommendations. The matching process is made visible through detailed views that expose the reasoning behind AI suggestions. Coaches receive clear information to support their decision-making. |
| Accountability                   | Humans remain in control. Workable AI provides intelligent job suggestions, but the final decisions are always made by the job coach. This ensures human oversight and ethical decision-making throughout the process. |
| Human Control and Oversight     | Humans remain in control. Workable AI provides intelligent job suggestions, but the final decisions are always made by the job coach. This ensures human oversight and ethical decision-making throughout the process. |
